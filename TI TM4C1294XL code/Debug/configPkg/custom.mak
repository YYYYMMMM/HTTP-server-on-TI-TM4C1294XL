...
linker.cmd: package/cfg/wifi_node_ap_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/wifi_node_ap_pem4fcfg.cmd\)\"$""\"F:/Embedded_System/PROJECT/http_serverCC3100/wifi_node_ap_tirtos/Debug/configPkg/\1\""' package/cfg/wifi_node_ap_pem4f.xdl > $@
